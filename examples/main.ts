...
createApp(App)
	.use(UIBase, {
		...
		$tmm: {
			themes: {
				dark: { label: '深色' },
				light: { label: '亮色', href: `${(import.meta as any).env.BASE_URL}assets/theme-light.css` },
				middle: { label: '中间色', href: `${(import.meta as any).env.BASE_URL}assets/theme-middle.css` },
			},
			default: 'dark',
			current: 'dark',
			values: {
