...
<script lang="ts">
	...
	import PopupManager, { IOptions as IPopupOptions } from './../src/PopupManager';
	...
	export default defineComponent({
		...
		setup() {
			...
			//
			return { onThemeChanged, onLocaleChanged, onOpenFull, popperRef1, onOpenPopper, onOpenLock, onOpenModal, pp, onOpenVueElm };
		},
	});
</script>
